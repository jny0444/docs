...
sidebar_position: 14
title: "14. Acessando o Protocolo P2P: Clientes e SDKs"
...
Claro, estes PWAs não são a única forma de acessar o Protocolo P2P. Qualquer entidade pode criar e distribuir um cliente de UI funcional para o Protocolo conduzir transações de on/off-ramp totalmente descentralizadas.

## 14.2 SDKs do Lado do Cliente (Integração B2B)

O SDK do Protocolo P2P permite que desenvolvedores integrem o protocolo para on/off-ramp de usuários diretamente em sua plataforma. Essencialmente, os SDKs habilitam a camada B2B para aplicativos Web2/Web3 prospectivos e websites acessarem e integrarem o Protocolo P2P diretamente em seu serviço, assim habilitando micropagamentos de consumidor em cripto entre outros possíveis casos de uso.
